      ...
      3: [
        function (require, module, exports) {
          (function (global) {
            ...
            var registerPlugin =
              _videoJs2["default"].registerPlugin ||
            ...
            var Overlay = (function (_Component) {
              ...
              function Overlay(player, options) {
                ...
                _get(
                  Object.getPrototypeOf(Overlay.prototype),
                  "constructor",
                  this
              ...
              _createClass(Overlay, [
                {
                  ...
                  value: function createEl() {
                    ...
                    var background = options.showBackground
                    ...
                    if (typeof content === "string") {
                      ...
                      content instanceof
                      _globalWindow2["default"].DocumentFragment
                    ) {
                ...
                },
                {
                  ...
                  value: function debug() {
                    ...
                    if (
                      log.hasOwnProperty(args[0]) &&
                      typeof log[args[0]] === "function"
                    ) {
                      fn = log[args.shift()];
                    }
                ...
                },
                {
                  ...
                  value: function hide() {
                    ...
                    this.debug("hidden");
                    this.debug(
                      'bound `startListener_` to "' + this.startEvent_ + '"'
                    );
                ...
                },
                {
                  ...
                  value: function show() {
                    ...
                    if (this.endEvent_) {
                      this.debug(
                        'bound `endListener_` to "' + this.endEvent_ + '"'
                      );
                  ...
                  value: function rewindListener_(e) {
                    ...
                    if (time < previous) {
                      ...
                      if (isNumber(end) && !this.shouldShow_(time)) {
                        this.debug(
                          (0, _tsmlj2["default"])(_templateObject2, end)
                        );
            ...
            var plugin = function plugin(options) {
              ...
              var settings = _videoJs2["default"].mergeOptions(
                defaults,
                options
              );
              ...
              this.overlays_ = overlays.map(function (o) {
                var mergeOptions = _videoJs2["default"].mergeOptions(
                  settings,
                  o
                );
